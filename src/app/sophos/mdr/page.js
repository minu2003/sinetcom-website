...
import { ShieldCheck, Zap, Target, Users, Activity, CheckCircle2 } from 'lucide-react';
import { colors } from '@/components/root';

// Images
import heroImage from '@/app/assets/solutions-image/sophos-mdr.png';
...
export default function MdrPage() {
  ...
  const features = [
    { icon: <Activity className="w-7 h-7" />, title: "24/7 Threat Monitoring", desc: "Continuous protection against evolving cyber threats" },
    { icon: <Zap className="w-7 h-7" />, title: "Rapid Incident Response", desc: "Immediate action to stop attacks" },
    { icon: <Target className="w-7 h-7" />, title: "Proactive Threat Hunting", desc: "Identify hidden risks before they escalate" },
    { icon: <Users className="w-7 h-7" />, title: "Expert Security Team", desc: "Dedicated analysts and responders working for you" },
    { icon: <ShieldCheck className="w-7 h-7" />, title: "Seamless Integration", desc: "Works with your existing security tools" },
  ];

  const whyChoose = [
    "Faster threat detection and response",
    "Reduced risk of breaches and downtime",
    "Lower operational burden on your IT team"
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 text-gray-900">
                Managed Detection & <span style={{ color: colors.primary }}>Response</span>
              </motion.h1>
              <motion.p variants={fadeInUp} className="text-gray-600 text-lg md:text-xl font-medium mb-4">
                Protect your business with 24/7 expert-driven cybersecurity powered by Sophos MDR.
              </motion.p>
              <motion.p variants={fadeInUp} className="text-gray-500 text-base leading-relaxed mb-10 max-w-lg">
                Sophos MDR combines advanced AI technology with a dedicated team of security experts to detect, investigate, and respond to cyber threats in real time before they impact your business.
              </motion.p>
            ...
            >
              ...
              <Image src={heroImage} alt="Sophos MDR" fill className="object-contain relative z-10 hover:scale-105 transition-transform duration-700 drop-shadow-2xl" priority />
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="flex flex-col items-center text-center">
            ...
            <motion.h2 variants={fadeInUp} className="text-3xl lg:text-4xl font-bold mb-6 text-gray-900 leading-tight">
              Why Choose <span style={{ color: colors.primary }}>MDR?</span>
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-gray-600 mb-10 text-lg">
              Cyberattacks are becoming more advanced, and managing security in-house is challenging. MDR gives you peace of mind with real-time proactive defense.
            </motion.p>
