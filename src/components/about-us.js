        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#050b18]/55 via-[#050b18]/15 to-transparent pointer-events-none" />
              <div className="absolute bottom-4 left-4 right-4 lg:bottom-5 lg:left-5 lg:right-5 rounded-2xl border border-white/15 bg-white/10 backdrop-blur-md px-4 py-3">
