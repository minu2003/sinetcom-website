...
export default function Footer() {
  ...
  const solutions = [
    ...
    { name: 'StorONE Solutions', href: '/solutions/storene' },
    { name: 'UPS Solutions', href: '/solutions/huawei/ups' },
    { name: 'Smart Server Rack Solutions', href: '/solutions/huawei/smart-server-rack' },
  ];
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © {currentYear} Sinetcom. All rights reserved.
            </p>
